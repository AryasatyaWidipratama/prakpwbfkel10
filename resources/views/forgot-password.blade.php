...
<body class="bg-gradient-success">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">We get it, stuff happens. Silahkan masukkan alamat email anda dibawah
                                            dan kita akan mengirim link untuk mereset password anda!</p>
                                    </div>
                                    <form class="user">
    ...
    <script src="style/assets/js/sb-admin-2.min.js"></script>
